...
$sql = "select * from personal where id = '$edit'";
    ...
    if(isset($_POST['submit']))
        {
          ...
          $mobile = $_POST['mobile'];
           ...
           $sql = "UPDATE `personal` SET `name`='$name',`email`='$email',`address`='$address',`mobile`='$mobile' WHERE id=$id";
...
<head>
    ...
    <title>Personal Application</title>
